...
#   (0.2ms)  BEGIN
#   (0.2ms)  SAVEPOINT active_record_1
#  Account Load (4.5ms)  SELECT  "accounts".* FROM "accounts" WHERE "accounts"."name" = $1 LIMIT 1  [["name", "KFC"]]
...
#   (0.2ms)  BEGIN
#   (0.2ms)  SAVEPOINT active_record_1
#  Account Load (0.3ms)  SELECT  "accounts".* FROM "accounts" WHERE "accounts"."name" = $1 LIMIT 1  [["name", "KFC"]]
#   (0.1ms)  RELEASE SAVEPOINT active_record_1
#   (0.3ms)  COMMIT
